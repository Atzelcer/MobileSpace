...
AProjectile_1::AProjectile_1()
{
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> TrailAsset(
		TEXT("ParticleSystem'/Game/MagicProjectilesVol2/Particles/Projectiles/P_Projectile_Fireball04_Orange.P_Projectile_Fireball04_Orange'")); // Cambia por el path que quieras
